...
//#define FT_MOTION
  ...
  #define FTM_SHAPING_DEFAULT_X_FREQ   37.0f      // (Hz) Frecuencia pico predeterminada utilizada por los conformadores de entrada para el eje X
  #define FTM_SHAPING_DEFAULT_Y_FREQ   37.0f      // (Hz) Frecuencia pico predeterminada utilizada por los conformadores de entrada para el eje Y
  #define FTM_LINEAR_ADV_DEFAULT_ENA   false      // Habilitar (true) o deshabilitar (false) el avance lineal predeterminado
  #define FTM_LINEAR_ADV_DEFAULT_K      0.0f      // Ganancia predeterminada del avance lineal
  #define FTM_SHAPING_ZETA_X            0.1f      // Zeta utilizado por los conformadores de entrada para el eje X
  #define FTM_SHAPING_ZETA_Y            0.1f      // Zeta utilizado por los conformadores de entrada para el eje Y

  #define FTM_SHAPING_V_TOL_X           0.05f     // Tolerancia de vibración utilizada por los conformadores de entrada EI para el eje X
  #define FTM_SHAPING_V_TOL_Y           0.05f     // Tolerancia de vibración utilizada por los conformadores de entrada EI para el eje Y

  //#define FT_MOTION_MENU                        // Proporcionar un menú MarlinUI para establecer parámetros M493
  ...
  #define FTM_UNIFIED_BWS                         // NO DESHABILITAR a menos que use Ulendo FBS (no implementado)
    ...
    #define FTM_BW_SIZE               100         // Tamaño de ventana y lote unificados con una relación de 2
  #else
  ...
  #if DISABLED(COREXY)
    #define FTM_STEPPER_FS          20000         // (Hz) Frecuencia para la actualización de entrada/salida de pasos

    // Utilice esto para ajustar el tiempo necesario para consumir el búfer de comandos.
    // Intente aumentar este valor si el movimiento del motor paso a paso es irregular.
    #define FTM_STEPPERCMD_BUFF_SIZE 3000         // Tamaño de los búferes de comandos de pasos
                                                  // (FTM_STEPS_PER_LOOP * FTM_POINTS_PER_LOOP) es un buen comienzo
                                                  // Si se queda sin memoria, vuelva a 3000 y aumente progresivamente
  #else
    // El movimiento CoreXY necesita un tamaño de búfer más grande. Estos valores se basan en nuestras pruebas.
  ...
  #define FTM_MIN_SHAPE_FREQ           10         // Frecuencia mínima de conformación
  #define FTM_RATIO (FTM_FS / FTM_MIN_SHAPE_FREQ) // Factor para usar en FTM_ZMAX. NO CAMBIAR.
  #define FTM_ZMAX (FTM_RATIO * 2)                // Retrasos máximos para funciones de conformación (solo números pares)
                                                  // Calcular como:
                                                  //   ZV       : FTM_RATIO / 2
                                                  //   ZVD, MZV : FTM_RATIO
                                                  //   2HEI     : FTM_RATIO * 3 / 2
...
#define DEFAULT_MINIMUMFEEDRATE             0.0     // (mm/s) Velocidad de avance mínimo. Establecer con M205 S.
#define DEFAULT_MINTRAVELFEEDRATE           0.0     // (mm/s) Velocidad de avance mínimo para desplazamientos. Establecer con M205 T.
#if HAS_ROTATIONAL_AXES
  #define DEFAULT_ANGULAR_MINIMUMFEEDRATE   0.0     // (°/s) Velocidad de avance mínimo para movimientos solo rotacionales. Establecer con M205 P.
  #define DEFAULT_ANGULAR_MINTRAVELFEEDRATE 0.0     // (°/s) Velocidad de avance mínimo para desplazamientos solo rotacionales. Establecer con M205 Q.
#endif
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  /**
   * Menú "Mover eje" de MarlinUI. Distancias del menú. Lista separada por comas.
   * Los valores se muestran según lo definido, así que siempre use números simples aquí.
   * Los movimientos de ejes <= 1/2 de la longitud del eje y movimientos de extrusor <= EXTRUDE_MAXLENGTH
...
#define SPEED_EDIT_MIN 10  // (%) Rango mínimo de edición de la velocidad de avance
#define SPEED_EDIT_MAX 999 // (%) Rango máximo de edición de la velocidad de avance
#endif
#if HAS_FLOW_EDIT
#define FLOW_EDIT_MIN  10  // (%) Rango mínimo de edición del flujo
#define FLOW_EDIT_MAX  999 // (%) Rango máximo de edición del flujo
#endif
...
// Opciones de progreso de impresión en la pantalla LCD. Se pueden mostrar varios valores en orden.
  ...
  // Opciones de ordenación de la tarjeta SD
    ...
    #define SDSORT_REVERSE     false  // Ordenar los nombres de archivo en orden inverso de manera predeterminada.
    #define SDSORT_LIMIT       40     // Número máximo de elementos ordenados (10-256). Cuesta 27 bytes cada uno.
    #define SDSORT_FOLDERS     -1     // -1=arriba  0=ninguno  1=abajo
    #define SDSORT_GCODE       false  // Habilitar el código G M34 para establecer comportamientos de ordenación: M34 S<-1|0|1> F<-1|0|1>
    #define SDSORT_USES_RAM    false  // Asignar estáticamente una matriz para una ordenación previa más rápida.
    #define SDSORT_USES_STACK  false  // Preferir la pila para la ordenación previa para devolver algo de SRAM. (Negado por las 2 siguientes opciones.)
    #define SDSORT_CACHE_NAMES false  // Mantener los elementos ordenados en RAM durante más tiempo para un rendimiento rápido. Opción más costosa.
    #define SDSORT_DYNAMIC_RAM false  // Utilizar asignación dinámica (dentro de los menús SD). Opción menos costosa. ¡Establecer SDSORT_LIMIT antes de usar!
    #define SDSORT_CACHE_VFATS 2      // Número máximo de entradas VFAT de 13 bytes a utilizar para la ordenación.
...
/**
 * De forma predeterminada, el framework es responsable de la E/S compartida de medios.
 * Habilita esto si necesitas que Marlin se encargue de la E/S compartida de medios.
 * Útil si la E/S compartida no funciona correctamente en algunas placas.
 */
 ...
 */
  ...
  // Solo se puede habilitar una opción de STATUS_HEAT_*
...
//
  ...
  #define DGUS_UI_WAITING               // Mostrar una pantalla de "espera" entre algunas pantallas
    ...
    /**
     * La versión de firmware de la pantalla táctil stock Ender-3 S1 Pro/Plus tiene un manejo de archivos SD bastante pobre.
     *
     * El autoscroll es principalmente útil para mensajes de estado, nombres de archivos y la página "Acerca de".
     *
     * NOTA: La opción de Tarjeta SD Avanzada se ve afectada por el firmware de la pantalla táctil de stock, por lo que
     *       las páginas 5 en adelante mostrarán "4/4". Esto puede corregirse en una actualización de firmware de la pantalla.
     */
    ...
    #define DGUS_ADVANCED_SDCARD            // Permitir más de 20 archivos y navegación de directorios
...
#endif
//
// Tiempo de espera de retroiluminación de la pantalla LCD
...
//#define BABYSTEPPING
  ...
  //#define BABYSTEP_GLOBAL_Z               // Combinar M424 Z y Ajuste fino global de Z

  #if ANY(BABYSTEP_ZPROBE_OFFSET, BABYSTEP_GLOBAL_Z)
    #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
      //#define BABYSTEP_HOTEND_Z_OFFSET    // Para múltiples hotends, ajuste fino relativo de offsets Z
    #endif
    //#define BABYSTEP_GFX_OVERLAY          // Habilitar superposición gráfica en el editor de offset Z
  #endif
#endif
...
/**
 * Control de Extrusión No Lineal
 *
 * Controla la velocidad de extrusión basándose en la velocidad instantánea del extrusor. Puede utilizarse
 * para corregir la subextrusión a altas velocidades del extrusor que, de lo contrario, son bien comportadas (es decir, sin saltos).
 */
...
/**
 * Esta característica es EXPERIMENTAL, así que úsela con precaución y pruébela a fondo.
 * Habilite esta opción para recibir datos en los puertos serie a través del controlador DMA integrado
 * para una comunicación serie de alta velocidad más estable y fiable.
 * Actualmente, solo algunos MCUs STM32 son compatibles.
 * Nota: Esto no afecta a los puertos serie USB emulados.
 */
//#define SERIAL_DMA
 ...
 *
 * Para clientes que utilizan una fuente de ancho fijo (como OctoPrint), deje esto configurado en 1.0.
 * De lo contrario, ajústelo según su cliente y fuente.
 */
 ...
 */
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_MIGRATION_FEATURE
     ...
     // Anular las configuraciones de cambio de herramienta
     // Por defecto, la migración de herramientas utiliza las configuraciones normales de cambio de herramienta.
     // Con una torre de purga, el intercambio/limpieza de herramientas ocurre dentro de la cama.
      // Al migrar a una nueva herramienta no purgada, puede establecer valores de anulación a continuación.
      //#define MIGRATION_ZRAISE            0 // (mm)

      // Purga más larga para limpiar
      //#define MIGRATION_FS_EXTRA_PRIME    0 // (mm) Longitud de purga adicional
      //#define MIGRATION_FS_WIPE_RETRACT   0 // (mm) Retraer antes de enfriar para reducir el stringing, mejorar la limpieza, etc.

      // Enfriar después de la purga para reducir el stringing
 ...
 * Actualmente solo admite un ciclo individual, sin encadenamiento de G-code.
 */
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
    ...
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX     20        // (mm^3/seg)
  #endif
#endif
...
/**
 * Desactivar M206 y M428 si no necesita desplazamientos de origen.
 */
...
//#define MAX7219_DEBUG
  ...
  //#define MAX7219_DEBUG_SLOWDOWN 6 // Contador (módulo 16) de cuántas veces SLOWDOWN ha reducido la velocidad de impresión.
#endif
